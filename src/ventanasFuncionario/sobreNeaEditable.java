...
public class sobreNeaEditable extends JPanel {
	...
	public sobreNeaEditable() {
		...
		panel_3_1.add(btnNewButton_1_1);
		  ...
		  JButton btnNewButton_2 = new JButton("");
	        ...
	        txtNaEsUna.setText("Texto inicial para el primer JTextField");
	        txtAvCalle.setText("Texto inicial para el segundo JTextField");
	        textField.setText("Texto inicial para el tercer JTextField");

	        // Bloquear los JTextField inicialmente
		...
		JButton btnOferta_1_2 = new JButton("Guardar cambios");
		btnOferta_1_2.setBounds(0, 0, 139, 36);
		panel_3_1.add(btnOferta_1_2);
	}
}
